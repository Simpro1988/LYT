        ...
        operate: {
            ...
            detailUrl: function(id) {
            	...
            	if ($.common.isNotEmpty(id)) {
            	    ...
            	    let id = $.common.isEmpty(table.options.uniqueId) ? $.table.selectFirstColumns() : $.table.selectColumns(table.options.uniqueId);
            	    if (id.length == 0) {
            ...
            // 考勤详细信息，以tab页展现
            attendanceDetailTab: function(id) {
                table.set();
                $.modal.openTab("考勤" + table.options.modalName, $.operate.attendanceDetailUrl(id));
            },
            // 修改信息 全屏
            ...
            // 修改访问地址
            attendanceDetailUrl: function(id) {
                var url = "/404.html";
                if ($.common.isNotEmpty(id)) {
                    url = table.options.detailUrl.replace("{id}", id);
                } else {
